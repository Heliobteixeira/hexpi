...
class HexLimb(object):
    def __init__(self, I2C_ADDRESS, femurLength, tibiaLength, femurInv, tibiaInv):
        ...
        self.femur.min_angle=0
        self.femur.max_angle=209 #Criar funcao especifica para carregar isto e verificar antes se servo permite
        self.tibia.min_angle=0
        self.tibia.max_angle=209 #Criar funcao especifica para carregar isto e verificar antes se servo permite
        if femurInv:
            self.femur.rev=-1
        else:
            self.femur.rev=1
